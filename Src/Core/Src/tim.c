...
void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = TIM1;
  htim1.Init.Prescaler = PWM_TIM_PRESCALER;
  htim1.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim1.Init.Period = PWM_TIM_COUNTER_MAX;
  ...
  sConfigOC.Pulse = (PWM_TIM_COUNTER_MAX+1)/2;
...
void MX_TIM5_Init(void)
{
  ...
  htim5.Init.Period = ENCODER_RESOLUTION-1;
