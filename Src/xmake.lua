...
target("test-dictionary")
    add_defines("TEST_RANDOLF","NON_STM32")
    set_kind("binary")
    add_includedirs("Library/Inc/", "Test/Inc")
    add_files("Library/Src/Util/dictionary.c")
    add_files("Test/Src/Util/dictionary_test.c")
...
target("test-string_operator")
    add_defines("TEST_RANDOLF","NON_STM32")
    set_kind("binary")
    add_includedirs("Library/Inc/", "Test/Inc")
    add_files("Library/Src/Util/string_operator.c")
    add_files("Test/Src/Util/string_operator_test.c")
...
target("test-motor_util")
    add_defines("TEST_RANDOLF", "NON_STM32")
    set_kind("binary")
    add_includedirs("Library/Inc/",  "Test/Inc", "Matlab/")
    add_files("Library/Src/Util/*.c","Library/Src/Motion/motor_util.c", "Matlab/*.c")
    add_files("Test/Src/Motion/motor_util_test.c")

target("test-motion_statemachine")
    add_defines("TEST_RANDOLF", "NON_STM32")
    set_kind("binary")
    add_includedirs("Library/Inc/",  "Test/Inc", "Matlab/", "Module/Inc")
    add_files("Library/Src/Util/*.c", "Library/Src/Controller/*.c", "Matlab/*.c")
    add_files("Test/Src/Controller/motion_statemachine_test.c")